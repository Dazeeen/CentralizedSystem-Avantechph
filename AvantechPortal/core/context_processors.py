...
PAGE_ACCESS_RULES = {
    ...
    'procurement_products': {'label': 'Products', 'perms': [CRM_ADMIN_PERMISSION, 'core.view_crm_technicals_section', 'core.view_client']},
    'procurement_purchase_requests': {'label': 'Purchase Orders', 'perms': [CRM_ADMIN_PERMISSION, 'core.view_crm_technicals_section', 'core.view_client']},
...
ERP_APP_DEFINITIONS = [
    ...
    },
    {
        'key': 'procurement',
        'label': 'Procurement',
        'description': 'Dashboard, store, purchase, suppliers, products, and suggestions.',
        ...
        'children': [
            ...
            {'label': 'Suppliers', 'url_name': 'procurement_suppliers', 'perms': [CRM_ADMIN_PERMISSION, 'core.view_crm_technicals_section', 'core.view_client'], 'active_url_names': ['procurement_canvassing_quotations']},
            {'label': 'Products', 'url_name': 'procurement_products', 'perms': [CRM_ADMIN_PERMISSION, 'core.view_crm_technicals_section', 'core.view_client']},
